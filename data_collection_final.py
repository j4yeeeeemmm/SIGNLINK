...
count = len(oss.listdir(r"C:\Users\63930\Desktop\JM FILES\THESIS\signlink\AtoZ_3.1\A"))
c_dir = 'A'
...
cv2.imwrite(r"C:\Users\63930\Desktop\JM FILES\THESIS\signlink\white.jpg",white)
...
while True:
    try:
        ...
        frame, hands= hd.findHands(frame, draw=False, flipType=True)
        white = cv2.imread(r"C:\Users\63930\Desktop\JM FILES\THESIS\signlink\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir(r"C:\Users\63930\Desktop\JM FILES\THESIS\signlink\AtoZ_3.1" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite(r"C:\Users\63930\Desktop\JM FILES\THESIS\signlink\AtoZ_3.1" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
